...
#		print("hand.gd: _update_pose(): legacy code fix, ",open_name, " | ", _animation_player.get_animation_library(open_name))# and.gd: _update_pose(): legacy code fix, Grip 5 | <Object#null> also gets sent twice?
#		var temp_var = _animation_player.get_animation_library(open_name)
		if open_name == "":
			open_name = "open_hand"
...
#			_animation_player.add_animation(open_name, open_pose)
			_animation_player.add_animation_library(open_name, _animation_player.get_animation_library(open_name))
...
#			_animation_player.add_animation(closed_name, closed_pose)
			_animation_player.add_animation_library(closed_name, _animation_player.get_animation_library(closed_name))
